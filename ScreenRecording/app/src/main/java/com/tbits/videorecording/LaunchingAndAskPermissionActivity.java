...
public class LaunchingAndAskPermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_launching_and_ask_permission);
        checkPermissions();
    ...
    private void startAction(){
        configureSettings();
        startActivityForResult(new Intent(LaunchingAndAskPermissionActivity.this,
                        MainActivity.class),
